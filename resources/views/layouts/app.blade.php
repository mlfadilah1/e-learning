    ...
    <section id="home">
         <div class="row">
                   ...
                   <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2268px, 0px, 0px); transition: all; width: 5292px;"><div class="owl-item cloned" style="width: 756px;"><div class="item item-second">
                        ...
                        </div></div><div class="owl-item cloned" style="width: 756px;"><div class="item item-third">
                             <div class="caption">
                                  <div class="container">
                                       <div class="col-md-6 col-sm-12">
                        ...
                        </div></div><div class="owl-item" style="width: 756px;"><div class="item item-first">
                             <div class="caption">
                                  <div class="container">
                                       <div class="col-md-6 col-sm-12">
                        ...
                        </div></div><div class="owl-item active" style="width: 756px;"><div class="item item-second">
                             <div class="caption">
                                  <div class="container">
                                       <div class="col-md-6 col-sm-12">
                                            <h1>Start your journey with our practical courses</h1>
                        ...
                        </div></div><div class="owl-item" style="width: 756px;"><div class="item item-third">
                             <div class="caption">
                                  <div class="container">
                                       <div class="col-md-6 col-sm-12">
                                            <h1>Efficient Learning Methods</h1>
                        ...
                        </div></div><div class="owl-item cloned" style="width: 756px;"><div class="item item-first">
                             <div class="caption">
                                  <div class="container">
                                       <div class="col-md-6 col-sm-12">
                                            <h1>Distance Learning Education Center</h1>
                        ...
                        </div></div><div class="owl-item cloned" style="width: 756px;"><div class="item item-second">
                             <div class="caption">
                                  <div class="container">
                                       <div class="col-md-6 col-sm-12">
                                            <h1>Start your journey with our practical courses</h1>
              ...
              <div class="row">
                   ...
                   <div class="col-md-12 col-sm-12">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2784px, 0px, 0px); transition: all; width: 7656px;"><div class="owl-item cloned" style="width: 696px;"><div class="col-md-4 col-sm-4">
                             ...
                             </div></div><div class="owl-item cloned" style="width: 696px;"><div class="col-md-4 col-sm-4">
                                  <div class="item">
                                       <div class="courses-thumb">
                                            <div class="courses-top">
                                                 <div class="courses-image">
                             ...
                             </div></div><div class="owl-item" style="width: 696px;"><div class="col-md-4 col-sm-4">
                                  <div class="item">
                                       <div class="courses-thumb">
                                            <div class="courses-top">
                                                 <div class="courses-image">
                             ...
                             </div></div><div class="owl-item active" style="width: 696px;"><div class="col-md-4 col-sm-4">
                                  <div class="item">
                                       <div class="courses-thumb">
                                            <div class="courses-top">
                                                 <div class="courses-image">
         ...
         <div class="container">
              <div class="row">
                   ...
                   <div class="col-md-12 col-sm-12">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-3480px, 0px, 0px); transition: all; width: 5568px;"><div class="owl-item cloned" style="width: 696px;"><div class="col-md-4 col-sm-4">
                                  <div class="item">
                                       <div class="tst-image">
